...
import jfdfs.fastdfs.StorageClient;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            */
            ...
            StorageClient client = new StorageClient(storageServer);
            byte[] file_buff;
            ...
            */
            if (results == null) {
                ...
                if (results != null) {
                    ...
                    generated_slave_filename = ProtoCommon
                            .genSlaveFilename(master_filename, prefix_name, file_ext_name);
